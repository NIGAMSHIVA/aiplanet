...
// below is the pdf supported code
...
// const initialStory = `One day, a hare was showing off how fast he could run. He laughed at the turtle for being so slow. After seeing the overconfidence, the turtle moved him to a race. The hare (rabbit) laughed at the turtle's test, and he accepted his demand.
...
// function App() {
//   const [uploadedFiles, setUploadedFiles] = useState([]);
//   const [rawText, setRawText] = useState(initialStory);
//   const [textChunks, setTextChunks] = useState([]);
//   const [loading, setLoading] = useState(false);
//   const [question, setQuestion] = useState('');
//   const [answer, setAnswer] = useState('');
